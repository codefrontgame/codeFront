...
export default new Level(
  ...
  [ // Hints
    ...
    'Den kod som står efter `if isInFrontOfRock:` körs bara när zombien står precis framför stenen.',
  ...
  [ // Helptexts
    ...
    'Testa dig gärna fram. Du kan alltid återställa koden om det skulle behövas genom att trycka på *Återställ*-knappen.',
  ],
  [ // Entities
